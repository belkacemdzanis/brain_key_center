...
const Login = () => {
  ...
  const handleRegister = async (e) => {
    ...
    try {
       const response = await axios.post(`${process.env.REACT_APP_API_URL}/api/users/${role}/register`,  {
        email,
        password,
        role,
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await axios.post(`${process.env.REACT_APP_API_URL}/api/users/${role}/login`,        {
        email,
        password,
      });
